    ...
    <footer className="bg-[#1E1E1E] text-gray-300 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 text-2xl font-serif text-[#D4AF37] mb-4">
              <Diamond size={24} />
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/marianoalonso10" target="_blank"  className="text-gray-400 hover:text-[#D4AF37] transition-colors duration-200">
          ...
          <div>
            <h3 className="text-lg font-medium mb-4 text-gray-200">Links rápidos</h3>
          ...
          <div>
            <h3 className="text-lg font-medium mb-4 text-gray-200">Contacto</h3>
